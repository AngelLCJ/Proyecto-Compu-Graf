...
Alumno Correa Juarez Angel Leonardo 
*/
//para cargar imagen
...
// average normals
	GLfloat cubo_vertices[] = {
		...
		0.5f, -0.5f,  -0.5f,	0.98f,	0.34f,		-1.0f,	0.0f,	0.0f,
		0.5f,  0.5f,  -0.5f,	0.98f,	0.66f,		-1.0f,	0.0f,	0.0f,
...
int main()
{
	...
	Dado_M = Model();
	Dado_M.LoadModel("Models/dado_animalesT.obj");
